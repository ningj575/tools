...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/pdf-to-images', component: () => import('./views/PdfToImagesView.vue'), meta: { title: '免费 PDF 转图片与长图 - 在线导出 JPG/PNG/WebP | 星路工具箱', description: '免费在线将 PDF 转换为逐页图片或纵向长图，支持 JPG、PNG、WebP、单张下载与 ZIP 批量下载，默认浏览器本地安全处理。', keywords: '免费PDF转图片,PDF转长图,PDF转JPG,PDF转PNG,PDF转WebP,在线PDF转换' } },
